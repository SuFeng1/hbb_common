...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "1711684936Ly".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["alycd.888761.xyz"];
pub const RS_PUB_KEY: &str = "iZLcQ8mBDALf8gxMdenIrBCh6CWDHXdUvkSbFTsgT0k=";
